    ...
    <div className="w-full pb-20">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lgl:grid-cols-3 xl:grid-cols-4 gap-10">
        ...
        <Product
          ...
          color="Mixed"
          badge={true}
          des="The Vivo 3 is a new generation bi-level ventilator designed for personalized and comfortable respiratory support – both non-invasive and invasive – for non-dependent patients with chronic breathing insufficiency. The intuitive interface ensures ease of use. A comprehensive set of modes and extensive monitoring capabilities allow for great flexibility, making the ventilator a perfect
